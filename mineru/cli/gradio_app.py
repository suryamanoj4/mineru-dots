...
def main(ctx,
    ...
    i18n = gr.I18n(
        en={
            ...
            "backend_info_lite": "Direct Tesseract-only OCR parsing with simpler execution and lower resource usage.",
        ...
        zh={
            ...
            "backend_info_lite": "仅使用 Tesseract 的轻量 OCR 解析，不复用完整 MinerU 管道，执行更简单、资源占用更低。",
    ...
    def get_formula_label(backend_choice):
        ...
        elif backend_choice in ["pipeline", "lite"]:
