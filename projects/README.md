# Welcome to the VParse Project List (Archived)
...
> If you have an excellent project based on VParse that you'd like to share, please submit the project link to the well-maintained community resource repository [awesome-vparse](https://github.com/opendatalab/awesome-vparse).  
> Thank you for your support and contribution to the VParse ecosystem!

## Project List

- Projects compatible with version 2.0:
  - [multi_gpu_v2](./multi_gpu_v2/README.md): Multi-GPU parallel processing based on LitServe
  - [vparse_heavy](./vparse_heavy/README.md): Asynchronous multi-GPU document parsing service based on VParse
