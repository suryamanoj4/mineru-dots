...
from vparse.utils.os_env_config import get_op_num_threads
...
class TSRUnet:
    def __init__(self, config: Dict):
        ...
        config["intra_op_num_threads"] = get_op_num_threads("VPARSE_INTRA_OP_NUM_THREADS")
        config["inter_op_num_threads"] = get_op_num_threads("VPARSE_INTER_OP_NUM_THREADS")
